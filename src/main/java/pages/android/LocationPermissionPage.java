...
public class LocationPermissionPage extends PageObject {
    ...
    public AndroidBindingInstructionPage allowPermissions() {
    ...
    public AndroidBindingInstructionPage confirmPermission() {
        fluentWaitForLocator(APP_ALLOW_BTN);
        return clickButton(getElementLocated(APP_ALLOW_BTN), AndroidBindingInstructionPage.class);
    }
