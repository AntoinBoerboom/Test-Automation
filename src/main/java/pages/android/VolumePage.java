...
public class VolumePage extends PageObject {
    ...
    private static final By PAGE_LOADED = By.id("activity_volume");

    @FindBy(id = "slider_left_hea")
    private WebElement sliderLeftUpBtn;

    @FindBy(id = "slider_handle")
    private WebElement sliderleftDownBtn;

    @FindBy(id = "slider_right_hea")
